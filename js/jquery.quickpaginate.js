...
(function($) {
  $.fn.quickpaginate = function( settings ){
  	...
  	var setNav = function(){
  		...
  		var pagerNav = $('<div class="'+settings.prev_class+'"><a href="#"><span id="button-next"></span></a></div><div class="'+settings.next_class+'"><a href="#"><span id="button-previous"></span></a></div>');
